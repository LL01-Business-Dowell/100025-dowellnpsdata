...
def text_qrcode_page(request):
    return render(request, 'qrcode.html', {'qrcode': 'http://127.0.0.1:8000/media/company_qrcode/DSC04502.jpg',
                                           'link': 'https://www.youtube.com/watch?v=Lv8LJo777CU&ab_channel=YRF'})
